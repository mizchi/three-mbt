...
test.beforeAll(async () => {
  const {outputFiles} = await build({entryPoints: [resolve('_build/js/release/build/mizchi/three-viewer/modeling/modeling.js')], bundle: true, platform: 'browser', format: 'esm', write: false});
