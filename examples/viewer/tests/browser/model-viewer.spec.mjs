...
const entry = resolve('_build/js/release/build/mizchi/three-viewer/model_viewer/model_viewer.js');
let moduleUrl;
...
async function assets(page) {
  ...
  await page.route('http://three.test/**', async route => {
    ...
    const body = await readFile(new URL(`../../../../tests/fixtures/${name}`, import.meta.url));
