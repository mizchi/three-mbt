...
test.beforeAll(async () => {
  const { outputFiles } = await build({ entryPoints: [resolve('_build/js/release/build/examples/advanced/advanced.js')], bundle: true, platform: 'browser', format: 'esm', write: false });
