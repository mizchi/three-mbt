...
import {fbx,collada,bvh} from '../fixtures/migration.mjs';
const url='http://migration.test/bundle.js';
let moduleSource;
test.beforeAll(async()=>{
 const {outputFiles}=await build({entryPoints:[resolve('_build/js/release/build/examples/migration/migration.js')],bundle:true,platform:'browser',format:'esm',write:false});
